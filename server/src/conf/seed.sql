...
VALUES
  ...
  (NOW(), NOW(), "Generic", "ST", "Story", "There is a narrative of some kind, they are actors, not porn stars."),
  (NOW(), NOW(), "Generic", "RL", "Realism", "Director is trying for some realism here in a <special> way."),
  (NOW(), NOW(), "Generic", "NP", "Normal People", "Not full of make-up covered models giving fake orgasms. Amateurs."),
  ...
  (NOW(), NOW(), "Fetish", "CR", "Crying", "Girl really isn't having much fun; ugly crying- tears, snot, etc require."),
  ...
  (NOW(), NOW(), "Incest", "BL", "Blood Relation", "Within reasoned odds that the actual people involved are relate."),
  ...
  (NOW(), NOW(), "Girl", "CS", "Curious", "Dunno, the girl just looks interesting. Eyes, face, demeanor, expression."),
  ...
  (NOW(), NOW(), "Series", "RRA", "Real Rape", "Established subseries that involve rape crimes that are very realistic."),
  (NOW(), NOW(), "Series", "CND", "Chikan Nakadashi", "Public rape on trains and buses + creampies."),
  (NOW(), NOW(), "Series", "GQU", "G-Queen", "Super soft-core that feature uncensored, totally bald pussy of incredibly."),
